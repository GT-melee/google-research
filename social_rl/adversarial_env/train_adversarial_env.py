...
flags.DEFINE_integer('num_parallel_envs', 4,
                     'Number of environments to run in parallel. Originally 30')  # CHARLIE so this is like vectorized environment from stable baselines. TODO make this like 6 or something
...
flags.DEFINE_boolean('debug', False,
                     'Turn on debugging and tf functions off.')  # CHARLIE probably need to turn this off
flags.DEFINE_boolean('agent_regret_off', False,  # CHARLIE keep this off
                     'If True, agents will train with normal reward not regret')
flags.DEFINE_boolean('unconstrained_adversary', False,
                     # CHARLIE need to use this to compare with unbounded minimax? I guess. But probably dont need it actually
                     'If True, does not use a second agent to constrain the '
                     'adversary environment.')
flags.DEFINE_boolean('domain_randomization', False,  # TODO CHARLIE follow where this is used
...
flags.DEFINE_boolean('no_adversary_rnn', False,  # TODO CHARLIE what is this
                     'If True, will not use an RNN to parameterize the '
                     'adversary environment')
flags.DEFINE_boolean('flexible_protagonist', False,  # CHARLIE see bellow "combined population"? idk TODO
