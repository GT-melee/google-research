...
class GatherEnv(multigrid.MultiGridEnv):
    ...
    def __init__(
        self, size=15, n_agents=3, n_goals=3, n_clutter=0, n_colors=1, random_colors=False, max_steps=250, **kwargs
    ):
    ...
    def _gen_grid(self, width, height):
        ...
        self.objects = []
        self.colors = (np.random.choice(len(minigrid.IDX_TO_COLOR) - 1, size=self.n_colors, replace=False) + 1).tolist()
...
class EmptyColorGatherEnv6x6(GatherEnv):
    def __init__(self, **kwargs):
        super().__init__(size=6, n_agents=2, n_goals=4, n_clutter=0, n_colors=2, **kwargs)


class RandomColorGatherEnv8x8(GatherEnv):
    def __init__(self, **kwargs):
        super().__init__(size=8, n_agents=2, n_goals=4, n_clutter=5, n_colors=2, **kwargs)


class EmptyColorGatherEnv10x10(GatherEnv):
    def __init__(self, **kwargs):
        super().__init__(size=10, n_agents=2, n_goals=6, n_clutter=0, n_colors=3, **kwargs)


class EmptyColorGatherEnv12x12(GatherEnv):
    def __init__(self, **kwargs):
        super().__init__(size=12, n_agents=3, n_goals=9, n_clutter=0, n_colors=3, **kwargs)


class RandomCountsColorGatherEnv12x12(GatherEnv):
    def __init__(self, **kwargs):
        super().__init__(size=12, n_agents=3, n_goals=9, n_clutter=0, n_colors=3, random_colors=True, **kwargs)


class EmptyColorGatherEnv15x15(GatherEnv):
    def __init__(self, **kwargs):
        super().__init__(size=15, n_agents=3, n_goals=12, n_clutter=0, n_colors=4, **kwargs)
...
register(env_id="MultiGrid-Gather-Empty-6x6-v0", entry_point=module_path + ":EmptyGatherEnv6x6")

register(env_id="MultiGrid-Gather-Random-8x8-v0", entry_point=module_path + ":RandomGatherEnv8x8")
