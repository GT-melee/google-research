...
register(env_id="MultiGrid-Empty-5x5-v0", entry_point=module_path + ":EmptyEnv")

register(env_id="MultiGrid-Empty-Random-5x5-v0", entry_point=module_path + ":EmptyRandomEnv5x5")

register(env_id="MultiGrid-Empty-8x8-v0", entry_point=module_path + ":EmptyEnv8x8")

register(env_id="MultiGrid-Empty-Random-8x8-v0", entry_point=module_path + ":EmptyRandomEnv8x8")

register(env_id="MultiGrid-Empty-16x16-v0", entry_point=module_path + ":EmptyEnv16x16")

register(env_id="MultiGrid-Empty-Random-16x16-v0", entry_point=module_path + ":EmptyRandomEnv16x16")
