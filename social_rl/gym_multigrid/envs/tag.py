...
class TagEnv(multigrid.MultiGridEnv):
    ...
    def __init__(self, size=15, hide_agents=1, seek_agents=1, n_clutter=25, max_steps=250, **kwargs):
    ...
    """
        ...
        super().__init__(
            grid_size=size, max_steps=max_steps, n_agents=hide_agents + seek_agents, fully_observed=True, **kwargs
        )
...
class RandomTagEnv6x6(TagEnv):
    def __init__(self, **kwargs):
        super().__init__(size=6, hide_agents=1, seek_agents=1, n_clutter=5, **kwargs)


class RandomTagEnv8x8(TagEnv):
    def __init__(self, **kwargs):
        super().__init__(size=8, hide_agents=2, seek_agents=3, n_clutter=10, **kwargs)
...
register(env_id="MultiGrid-Tag-Random-6x6-v0", entry_point=module_path + ":RandomTagEnv6x6")

register(env_id="MultiGrid-Tag-Random-8x8-v0", entry_point=module_path + ":RandomTagEnv8x8")
