...
class ClutteredMultiGrid(multigrid.MultiGridEnv):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            grid_size=size, max_steps=max_steps, n_agents=n_agents, agent_view_size=agent_view_size, **kwargs
        )
...
class ClutteredMultiGridSingle6x6(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(
            n_agents=1, size=6, n_clutter=5, randomize_goal=True, agent_view_size=5, max_steps=50, **kwargs
        )
...
class ClutteredMultiGridSingle(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(
            n_agents=1, size=15, n_clutter=25, randomize_goal=True, agent_view_size=5, max_steps=250, **kwargs
        )
...
class Cluttered1MinigridMini(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, n_clutter=1, minigrid_mode=True, size=6, **kwargs)


class Cluttered6MinigridMini(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, n_clutter=6, minigrid_mode=True, size=6, **kwargs)


class Cluttered7MinigridMini(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, n_clutter=7, minigrid_mode=True, size=6, **kwargs)


class ClutteredMinigridLava(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, walls_are_lava=True, minigrid_mode=True, **kwargs)


class ClutteredMinigridLavaMini(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, n_clutter=4, walls_are_lava=True, size=6, minigrid_mode=True, **kwargs)


class ClutteredMinigridLavaMedium(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, n_clutter=15, walls_are_lava=True, size=10, minigrid_mode=True, **kwargs)


class Cluttered15MinigridMedium(ClutteredMultiGrid):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, n_clutter=15, minigrid_mode=True, size=10, **kwargs)
...
register(env_id="MultiGrid-Cluttered-v0", entry_point=module_path + ":ClutteredMultiGrid")
...
register(env_id="MultiGrid-Cluttered10-Minigrid-v0", entry_point=module_path + ":Cluttered10Minigrid")

register(env_id="MultiGrid-Cluttered50-Minigrid-v0", entry_point=module_path + ":Cluttered50Minigrid")
