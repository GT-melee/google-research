...
class StagHuntEnv(multigrid.MultiGridEnv):
    ...
    def __init__(self, size=15, n_agents=2, n_stags=2, n_plants=2, n_clutter=0, penalty=1.0, max_steps=250, **kwargs):
...
class EmptyStagHuntEnv7x7(StagHuntEnv):
    def __init__(self, **kwargs):
        super().__init__(size=7, n_agents=2, n_stags=1, n_plants=2, penalty=0.5, **kwargs)
...
class RandomStagHuntEnv8x8(StagHuntEnv):
    def __init__(self, **kwargs):
        super().__init__(size=8, n_agents=2, n_stags=2, n_plants=3, n_clutter=5, **kwargs)
...
class EmptyStagHuntEnv10x10(StagHuntEnv):
    def __init__(self, **kwargs):
        super().__init__(size=10, n_agents=2, n_stags=2, n_plants=3, n_clutter=0, **kwargs)
...
register(env_id="MultiGrid-StagHunt-v0", entry_point=module_path + ":StagHuntEnv")

register(env_id="MultiGrid-StagHunt-Empty-6x6-v0", entry_point=module_path + ":EmptyStagHuntEnv6x6")

register(env_id="MultiGrid-StagHunt-Empty-8x8-v0", entry_point=module_path + ":EmptyStagHuntEnv8x8")

register(env_id="MultiGrid-StagHunt-NoStag-8x8-v0", entry_point=module_path + ":NoStagHuntEnv8x8")

register(env_id="MultiGrid-StagHunt-AllStag-8x8-v0", entry_point=module_path + ":AllStagHuntEnv8x8")

register(env_id="MultiGrid-StagHunt-Random-8x8-v0", entry_point=module_path + ":RandomStagHuntEnv8x8")

register(env_id="MultiGrid-StagHunt-Empty-10x10-v0", entry_point=module_path + ":EmptyStagHuntEnv10x10")
