...
class TwoRoomsEnvMinigrid(FourRoomsEnv):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, minigrid_mode=True, agent_view_size=5, grid_size=15, two_rooms=True, **kwargs)


class FourRoomsEnvMinigrid(FourRoomsEnv):
    def __init__(self, **kwargs):
        super().__init__(grid_size=15, agent_view_size=5, minigrid_mode=True, n_agents=1, **kwargs)


class MiniTwoRoomsEnvMinigrid(FourRoomsEnv):
    def __init__(self, **kwargs):
        super().__init__(n_agents=1, minigrid_mode=True, agent_view_size=5, grid_size=6, two_rooms=True, **kwargs)


class MiniFourRoomsEnvMinigrid(FourRoomsEnv):
    def __init__(self, **kwargs):
        super().__init__(grid_size=6, agent_view_size=5, minigrid_mode=True, n_agents=1, **kwargs)
...
register(env_id="MultiGrid-FourRooms-v0", entry_point=module_path + ":FourRoomsEnv")

register(env_id="MultiGrid-FourRooms-15x15-v0", entry_point=module_path + ":FourRoomsEnv15x15")

register(env_id="MultiGrid-FourRooms-Single-v0", entry_point=module_path + ":FourRoomsEnvSingle")

register(env_id="MultiGrid-TwoRooms-Minigrid-v0", entry_point=module_path + ":TwoRoomsEnvMinigrid")
