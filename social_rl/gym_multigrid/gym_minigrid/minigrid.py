...
class Grid:
    ...
    def wall_rect(self, x, y, w, h, obj_type=Wall): # CHARLIE added the obj_type so that we can change the wall color post-init
    ...
    def render_tile(
        ...
        if obj != None:
            ...
            fill_coords(img, point_in_rect(0, 1, 0, 1), COLORS[floor_color])
    ...
    def encode(self, is_not_shifted=False, vis_mask=None):  # SHOULD ALWAYS BE FALSE?
        """
    ...
    @staticmethod
    def decode(array):
        raise NotImplementedError("OH NO WE ACTUALLY USE THE DECODE METHOD?! CHARLIE MESSED UP")
        """
